...
Hãy phân tích các vấn đề về privacy, data protection, data breach, consent,
quyền của chủ thể dữ liệu, nghĩa vụ thông báo rò rỉ dữ liệu và mức phạt có thể phát sinh."""
    response = llm.invoke([HumanMessage(content=prompt)])
